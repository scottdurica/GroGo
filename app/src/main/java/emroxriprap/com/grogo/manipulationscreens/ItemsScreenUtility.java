...
public class ItemsScreenUtility extends ActionBarActivity {
    ...
    public static class StoresScreenUtility extends emroxriprap.com.grogo.manipulationscreens.StoresScreenUtility {
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            // Inflate the menu; this adds items to the action bar if it is present.
            getMenuInflater().inflate(R.menu.menu_stores_screen, menu);
            return true;
        }
